        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Movie Tags</h1>
                    <p class="mb-4">View, add, change, and delete existing Tags in the database.
                    </p>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-4">
                            ...
                            <a href="add-qualities.php" class="btn btn-sm btn-primary">+ Quality</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($genre)) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="edit-genre?id_kualitas=<?= $row['id_kualitas']; ?>"
