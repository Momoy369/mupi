        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Movies Subtitles</h1>
                    <p class="mb-4">View, add, change and delete existing movies subtitles in the database.</p>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-4 d-flex justify-content-between align-items-center">
                            ...
                            <h5 class="m-0 font-weight-bold text-primary">
                                <?= htmlspecialchars($resultMovies['judul']); ?>
                                Subtitles
                            </h5>
                            <a href="add-movie-subtitles?movies=<?= $id; ?>" class="btn btn-sm btn-primary ml-auto">+
                                Subtitles</a>
                        </div>
        ...
        $(document).ready(function () {
            ...
            var movieListTable = $('#movieList').DataTable({
                ...
                columns: [
                    ...
                    { data: 'movie_id', className: 'text-center' },
