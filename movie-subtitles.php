...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Movie Subtitles</h1>
                    <p class="mb-4">View, add, change and delete existing movie subtitles in the database.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-4 d-flex justify-content-between align-items-center">
                            <h5 class="m-0 font-weight-bold text-primary">Movie Subtitles</h5>
                            <a href="add-movie-subtitles" class="btn btn-sm btn-primary ml-auto">+ Subtitle</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="movieSubtitle" width="100%" cellspacing="0">
    ...
    <script>
        $(document).ready(function () {
            var movieSubtitleListTable = $('#movieSubtitle').DataTable({
                responsive: true,
                serverSide: true,
                ajax: {
                    url: 'movie_subtitles_get.php',
                    type: 'POST',
                    data: function (d) {
