        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Series Episode Subtitles</h1>
                    <p class="mb-4">Here you can add series episode subtitles. Fill in the details in each field
                        provided in the
                        form
                        below.</p>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-4">
                            <h5 class="m-0 font-weight-bold text-primary">Add Series Episode Subtitles</h5>
                        </div>
                        <?php
                        ...
                        ?>
                        <form class="form mt-4" role="form" method="POST" action="action/add-series-episode-subtitles"
