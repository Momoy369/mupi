        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Actor/Actress</h1>
                    <p class="mb-4">Here you can add actors and actresses. Fill in the details in each field provided in
                        the form below.</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form class="form mt-4" role="form" method="POST" action="action/add-actors.php"
                            ...
                            <div class="form-group">
                                <div class="row p-4">
                                    <div class="col-lg-6">
                                        <label for="">Actor/Actress Name</label>
                                        <input type="text" class="form-control" name="nama_aktor">
                                    </div>

                                    <div class="col-lg-6">
                                        <label for="">Actor/Actress Photo</label>
