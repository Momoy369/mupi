        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">View, add, change and delete existing tv series in the database.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-4 d-flex justify-content-between align-items-center">
                            <h5 class="m-0 font-weight-bold text-primary">Series List</h5>
                            <a href="add-series" class="btn btn-sm btn-primary ml-auto">+ Series</a>
                        </div>
        ...
        $(document).ready(function () {
            var movieListTable = $('#movieList').DataTable({
                ...
                columns: [
                    ...
                    { data: 'episodes', className: 'text-center' },
                    { data: 'seasons', className: 'text-center' },
